 ...
 * Inc., 51 Franklin Street, Fifth Floor, Boston, MA 020-1301, USA.
 *
...
class SCA_PythonOmni : public PyObjectPlus
{
	Py_Header
private:
	class SCA_Omni *m_Omni;
#ifdef WITH_PYTHON
	PyObject* m_event_dict;
#endif
public:
	SCA_PythonOmni(class SCA_Omni* Omni);
	virtual ~SCA_PythonOmni();
