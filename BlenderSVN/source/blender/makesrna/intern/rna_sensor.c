...
EnumPropertyItem *rna_Sensor_type_itemf(bContext *C, PointerRNA *ptr, PropertyRNA *UNUSED(prop), int *free)
{
	...
	RNA_enum_items_add_value(&item, &totitem, sensor_type_items, SENS_OMNI);
...
static void rna_def_omni_sensor(BlenderRNA *brna)
{
	StructRNA *srna;
	PropertyRNA *prop;
